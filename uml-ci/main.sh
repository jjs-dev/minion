...
wget https://download.fedoraproject.org/pub/fedora/linux/releases/33/Cloud/x86_64/images/Fedora-Cloud-Base-33-1.2.x86_64.raw.xz -O img.xz
unxz img.xz
wget https://cdn.kernel.org/pub/linux/kernel/v5.x/linux-5.4.93.tar.xz
tar -xvJf linux-5.4.93.tar.xz
(
cd linux-5.4.93
export ARCH=um
make defconfig
