...
linux-5.4.93/linux mem=4096M ubda=img rootfstype=hostfs init=/bin/
linux-5.4.93/linux mem=4096M ubda=img rootfstype=hostfs init=/bin/true
linux-5.4.93/linux mem=4096M ubda=img rootfstype=hostfs init=/bin/bash "$PWD"/uml-setup.sh
